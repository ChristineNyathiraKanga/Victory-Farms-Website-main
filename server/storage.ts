...
export class MemStorage implements IStorage {
  ...
  private initializeData() {
    ...
    const products: Product[] = [
      ...
      {
        id: "3",
        name: "Fish Powder - Kenya's First Superfood",
        ...
        tags: ["Superfood", "Nutrition", "Made in Kenya"],
        inStock: 1,
      },
    ];
    ...
    const teamMembers: TeamMember[] = [
      {
        ...
        bio: "Upon visiting Kenya in 2019 Kamran was inspired to build an aquaculture business in Africa to tackle the problem of affordable and sustainable protein production. In pursuit of this mission, he joined Victory Farms, the largest fish farm in East Africa based in Kenya, in 2020, and in late 2021 launched the organization's Kenyan counterpart, founding Kivu Choice.",
      ...
      },
      {
        ...
        bio: "Ben is an impact-driven leader who takes an active role in leading teams to deliver results. Most recently leading Sales for Bboxx Kenya, the largest retail solar company in Africa, he will take on responsibility for Kivu Choice's commercial operations and expansion.",
      ...
      },
      {
        ...
        bio: "Gordon Bradford has over 3 decades of experience in construction, maintenance, security, and project management in Africa. Gordon started his aquaculture career with Victory Farms in Kenya for one year before moving over to Kenya and was the first employee at Kivu Choice.",
      ...
      },
      {
        ...
        bio: "Ronah is an experienced hatchery expert with experience spanning over 10 years in Uganda, Kenya, Ghana, and Kenya. Her keen ability to develop and manage people while getting excellent results makes her a great resource for Kivu Choice. Her hobbies include travelling and experiencing different cultures.",
      ...
      },
      {
        ...
        bio: "David is a proficient and outcome-driven leader with extensive experience in logistics and supply chain management, acquired from roles at DHL, Abahizi Kenya, and Wasoko.",
